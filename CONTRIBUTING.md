...
* **Which `{{artifactId}}` version(s)** - which library version(s) you used when the issue occurred.
...
[issue-link]: https://github.com/infobip/infobip-cpaasx-python-clien/issues/new
